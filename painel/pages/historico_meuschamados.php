...
<div class="box_content">
	<h2><i class="fa-solid fa-book-open-reader"></i>&nbsp; Meu Histórico de Atendimentos</h2>
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST'){
        ...
        foreach ($array as $key => $result) {
            ...
            $resulta1 = select::historicochamado($solicitante, $atendente, $periodoabertura1, $periodoabertura2, $periodofechamento1, $periodofechamento2, $dtabertura, $dtfechamento, null);
